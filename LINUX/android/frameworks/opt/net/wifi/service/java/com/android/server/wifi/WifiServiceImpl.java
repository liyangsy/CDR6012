...
public final class WifiServiceImpl extends IWifiManager.Stub {
    ...
    public void checkAndStartWifi() {
        ...
        Slog.i(TAG, "WifiService starting up with Wi-Fi " +
                ...
                // Add by Skysoft start
                +", Softap " + (softapEnabled ? "enabled" : "disabled"));
                // Add by Skysoft end
    ...
    public void setWifiApEnabled(WifiConfiguration wifiConfig, boolean enabled) {
        ...
        // Add by Skysoft start
        Slog.d(TAG, "setWifiApEnabled : " + enabled);
        // Add by Skysoft end
        ...
        if (wifiConfig == null || isValid(wifiConfig)) {
            ...
            // Add by Skysoft start
            mSettingsStore.persistWifiApState(enabled ? 1 : 0);
            // Add by Skysoft end
        } else {
    ...
    /*Askey Added AP WPS Func for Pionner Req 082516 Scottj*/
     public int getApWpsStatus() {
        enforceAccessPermission();
        return mWifiStateMachine.syncGetApWpsStatus();
     }
    ...
    public boolean startApWpsPbc() {
        ...
        enforceChangePermission();
        if (mWifiStateMachineChannel != null) {
            return mWifiStateMachine.syncStartApWps(mWifiStateMachineChannel, null);
        } else {
            Slog.e(TAG, "mWifiStateMachineChannel is not initialized!");
            return false;
        }
    ...
    public boolean startApWpsPin(String pinCode) {
        ...
        if (mWifiStateMachineChannel != null) {
            return mWifiStateMachine.syncStartApWps(mWifiStateMachineChannel, pinCode);
        } else {
            Slog.e(TAG, "mWifiStateMachineChannel is not initialized!");
            return false;
        }
    ...
    public boolean cancelApWps() {
        enforceChangePermission();
        if (mWifiStateMachineChannel != null) {
            return mWifiStateMachine.syncCancelApWps(mWifiStateMachineChannel);
        } else {
            Slog.e(TAG, "mWifiStateMachineChannel is not initialized!");
            return false;
        }
