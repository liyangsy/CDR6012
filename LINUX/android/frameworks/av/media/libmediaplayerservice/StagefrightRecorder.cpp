...
sp<MediaSource> StagefrightRecorder::createAudioSource() {
    ...
    #if 1 //harrison modified for testing and demo 20160804
    ...
    #else
        ALOGE("skipp audio source initialized check !! \n");
    #endif
...
status_t StagefrightRecorder::setupMPEG2TSRecording() {
    ...
    #if 0
        //harrison modified for testing and demo 20160804        
        ALOGE("hardbg: setupMPEG2TSRecording, skipp setupAudioEncoder !! \n");    
    #else
    if (mAudioSource != AUDIO_SOURCE_CNT) {
...
status_t StagefrightRecorder::setupMPEG4orWEBMRecording() {
    ...
    if (mOutputFormat != OUTPUT_FORMAT_WEBM) {
        ...
        //harrison modified for testing and demo 20160804
        disableAudio = true;
        ALOGE("hardbg: setupMPEG4orWEBMRecording, disableAudio = true !! \n");
        #endif
