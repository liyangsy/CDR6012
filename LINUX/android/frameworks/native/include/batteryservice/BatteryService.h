...
enum {
    ...
    BATTERY_HEALTH_WARM = 5, // equals BatteryManager.BATTERY_HEALTH_WARM constant
    BATTERY_HEALTH_COOL = 6, // equals BatteryManager.BATTERY_HEALTH_COOL constant
    BATTERY_HEALTH_COLD = 7, // equals BatteryManager.BATTERY_HEALTH_COLD constant
    BATTERY_HEALTH_UNSPECIFIED_FAILURE = 8, // equals BatteryManager.BATTERY_HEALTH_UNSPECIFIED_FAILURE constant
};
