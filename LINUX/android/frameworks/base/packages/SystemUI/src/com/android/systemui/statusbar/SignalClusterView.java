...
public class SignalClusterView
    ...
    private int mWifiStrengthId = 0, mWifiActivityId = 0, mClientCount = 0;
    ...
    public void setWifiIndicators(boolean enabled, IconState statusIcon, IconState qsIcon,
            boolean activityIn, boolean activityOut, String description, int clientCount) {
    ...
    private void apply() {
        ...
        if (mWifiVisible) {
            if (wifi.isWifiApEnabled()) {
                setWifiAPClientCount();
            } else if (mWifiStrengthId != mLastWifiStrengthId) {
			...
			mWifi.setImageResource(R.drawable.stat_sys_wifi_signal_null);
        }
	...
	public void setWifiAPClientCount() {
        if (mClientCount == 0) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_0);
        } else if (mClientCount == 1) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_1);
        } else if (mClientCount == 2) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_2);
        } else if (mClientCount == 3) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_3);
        } else if (mClientCount == 4) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_4);
        } else if (mClientCount == 5) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_5);
        } else if (mClientCount == 6) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_6);
        } else if (mClientCount == 7) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_7);
        } else if (mClientCount == 8) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_8);
        } else if (mClientCount == 9) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_9);
        } else if (mClientCount == 10) {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_10);
        } else {
            mWifi.setImageResource(R.drawable.stat_sys_wifi_ap_connected_10);
        }
    }
