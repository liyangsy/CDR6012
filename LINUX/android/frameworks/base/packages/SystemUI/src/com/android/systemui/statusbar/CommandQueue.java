...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_SET_NAVIGATION_BAR_ITEM      = 25 << MSG_SHIFT;
    ...
    public void setNavigationBarItem(int right_1, int right_2, int right_3, int bottom_1) {
        synchronized (mList) {
            int[] tmp = {right_1, right_2, right_3, bottom_1};
            mHandler.obtainMessage(MSG_SET_NAVIGATION_BAR_ITEM, tmp).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_CAMERA_LAUNCH_GESTURE:
                    ...
                    break;
                case MSG_SET_NAVIGATION_BAR_ITEM:
                    int[] tmp = (int[]) msg.obj;
                    if (tmp!= null && tmp.length == 4)
                        mCallbacks.setNavigationBarItem(tmp[0], tmp[1], tmp[2], tmp[3]);
                    break;
            }
        }
    }
