...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
        ...
        @ViewDebug.ExportedProperty(mapping = {
            ...
            @ViewDebug.IntToString(from = TYPE_NAVIGATION_BAR_PIONEER, to = "TYPE_NAVIGATION_BAR_PIONEER"),
        })
        public int type;
         ...
         * @hide
         */
        public static final int TYPE_NAVIGATION_BAR_PIONEER = FIRST_SYSTEM_WINDOW+34;
