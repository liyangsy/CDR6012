...
public class RecoverySystem {
    ...
    /**
     * allen@20161020, reboot to execute new command "factory_reset" in recovery
     * @hide
     */
    public static void rebootFactoryReset(Context context, boolean shutdown, String reason)
            throws IOException {
        UserManager um = (UserManager) context.getSystemService(Context.USER_SERVICE);
        if (um.hasUserRestriction(UserManager.DISALLOW_FACTORY_RESET)) {
            throw new SecurityException("Wiping data is not allowed for this user.");
        ...
        final String localeArg = "--locale=" + Locale.getDefault().toString();
        bootCommand(context, shutdownArg, "--factory_reset", reasonArg, localeArg);
    }
