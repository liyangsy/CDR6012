...
public final class PowerManager {
    ...
    /**
     * The value to pass as the 'reason' argument to reboot() to
     * reboot into charging mode 
     * <p>
     * {@link android.Manifest.permission#REBOOT}).
     * </p>
     * @hide
     */
    public static final String REBOOT_CHARGING_MODE = "chargemode";

    /**
     * The value to pass as the 'reason' argument to reboot() to
     * reboot into battery hot limited mode
     * <p>
     * @hide
     */
    public static final String REBOOT_HOT_LIMITED_MODE = "hotbatt";
   ...
   /**
    ...
    public void setScreenOff(long time) {
        goToSleep(time, GO_TO_SLEEP_REASON_APPLICATION, 0);
    }
    ...
    public void wakeUp(long time) {
     ...
     public void setScreenOn(long time) {
        try {
            mService.wakeUp(time, "wakeUp", mContext.getOpPackageName());
        } catch (RemoteException e) {
        }
   ...
   /**
    ...
    public void reboot_charging() {
        try {
            mService.reboot(false, REBOOT_CHARGING_MODE, true);
        } catch (RemoteException e) {
        }
    }
    ...
    public int getAccState() {
     ...
     /**
     * reset battery charge cyle 
     *
     *
     * @see #resetBatteryAgingState()
     *
     */
    public void resetBatteryAgingState() {
        try {
            mService.resetBatteryAgingState();
        } catch (RemoteException e) {
    ...
    /**
     * Intent that is broadcast when the state of ACC is about to change.
     * This broadcast is only sent to registered receivers.
     *
     */
    @SdkConstant(SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_POWER_CONNECTED
            = "android.acc.action.POWER_CONNECTED";
    ...
    public static final String ACTION_POWER_DISCONNECTED
            = "android.acc.action.POWER_DISCONNECTED";      
