...
public class BatteryProperties implements Parcelable {
    ...
    public void set(BatteryProperties other) {
        ...
        batteryAging = other.batteryAging;
        batteryAcc = other.batteryAcc;
    }
    ...
    private BatteryProperties(Parcel p) {
        ...
        batteryAging = p.readInt();
        batteryAcc = p.readInt();
    }
    ...
    public void writeToParcel(Parcel p, int flags) {
        ...
        p.writeInt(batteryAging);
        p.writeInt(batteryAcc);
    }
