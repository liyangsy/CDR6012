...
public class BatteryManager {
    ...
    /**
     * Extra for {@link android.content.Intent#ACTION_BATTERY_CHANGED}:
     * Int value for battery cycle count
     * {@hide}
     */
    public static final String EXTRA_BATTERY_AGING = "battery_aging";
    
    /**
     * Extra for {@link android.content.Intent#ACTION_BATTERY_CHANGED}:
     * Int value for Acc state
     * {@hide}
     */
...
//    public static final int BATTERY_HEALTH_UNSPECIFIED_FAILURE = 6;
    public static final int BATTERY_HEALTH_WARM = 5;
    public static final int BATTERY_HEALTH_COOL = 6;
    public static final int BATTERY_HEALTH_COLD = 7;
    public static final int BATTERY_HEALTH_UNSPECIFIED_FAILURE = 8;
