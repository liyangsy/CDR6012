...
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
        private static final String KEY_WDR_MODE = "video-wdr"; 		
...
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
         /** @hide
         * Gets the supported Video WDR modes.
         *
         * @return a List of Video WDR_OFF/OFF string constants. null if
         * Video WDR mode setting is not supported.
         */
         public List<String> getSupportedVideoWDRModes() {
            String str = get(KEY_WDR_MODE + SUPPORTED_VALUES_SUFFIX);
            return split(str);
         }		 
/* End : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */
...
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
	/** @hide
	  * Gets the current Video WDR Mode.
	  *
  	  * @return Video WDR mode value
	  */
	 public String getVideoWDRMode() {
	    	return get(KEY_WDR_MODE);
	 }

	/** @hide
	  * Sets the current Video WDR Mode.
	  *
	  * @return null
	  */
	 public void setVideoWDRMode(String videowdr) {
   	   	set(KEY_WDR_MODE, videowdr);
	 }		 
/* End : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */
