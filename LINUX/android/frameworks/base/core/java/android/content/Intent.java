...
public class Intent implements Parcelable, Cloneable {
    ...
    /**
     * Activity Action: Start action associated with press type of  power key.
     * <p>Input: Nothing.
     * <p>Output: Nothing.
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_POWERKEY_PRESS_TYPE = "android.intent.action.POWERKEY_PRESS_TYPE";
    
     /**
     * Activity Action: Start action associated with press type of key.
     * <p>Input: Nothing.
     * <p>Output: Nothing.
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_KEY_PRESS_TYPE = "android.intent.action.KEY_PRESS_TYPE";

     /**
     * Activity Action:  The user pressed the "NS" button to enable Noise Suppression
     * feature when video
     * <p>Input: Nothing.
     * <p>Output: Nothing.
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_NOISE_SUPPRESSION = "android.intent.action.NOISE_SUPPRESSION";
   ...
   /**
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_TURN_ON_DEVELOP_MODE = "android.intent.action.TURN_ON_DEVELOP_MODE";

    /**
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_SHOW_DEVELOPMODE = "android.intent.action.SHOW_DEVELOPMODE";
    ...
    /**
     * A {@link #ACTION_POWERKEY_PRESS_TYPE} object containing the type of power key press 
     */
    public static final String EXTRA_POWERKEY_PRESS_TYPE= "android.intent.extra.POWERKEY_PRESS_TYPE";

    /**
     * A {@link #ACTION_KEY_PRESS_TYPE} object containing the type of power key press
     */
    public static final String EXTRA_KEY_PRESS_TYPE= "android.intent.extra.KEY_PRESS_TYPE";
