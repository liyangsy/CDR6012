...
public final class Settings {
    ...
    public static final class Secure extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.WIFI_AP_SAVED_STATE);
            // Add by Skysoft end
    ...
    public static final class Global extends NameValueTable {
       ...
       // Add by Skysoft start
       /**
        * Used to save the Wifi_AP_ON state prior to start STA mode.
        * This state will be checked to restore AP mode after
        * the user turns off STA mode.
        *
        * @hide
        */
