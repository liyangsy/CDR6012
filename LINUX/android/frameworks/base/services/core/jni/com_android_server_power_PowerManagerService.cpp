...
/* charge cycle */
static void nativeSetChargeCycletoKernel(JNIEnv *env, jclass /* clazz */, jint value) {
    set_kernel_currstate(value);
}

static void nativeSetChargeCycletoBlocker(JNIEnv *env, jclass /* clazz */, jint startbyte, jint value) {
    set_bcc_raw(startbyte,value);
}

static jint nativeGetChargeCyclefromBlocker(JNIEnv *env, jclass /* clazz */, jint startbyte) {
    
    return get_bcc_raw(startbyte);
}
...
static JNINativeMethod gPowerManagerServiceMethods[] = {
    ...
    { "nativeSetChargeCycletoKernel", "(I)V",
            (void*) nativeSetChargeCycletoKernel },
    { "nativeSetChargeCycletoBlocker", "(II)V",
            (void*) nativeSetChargeCycletoBlocker },
    { "nativeGetChargeCyclefromBlocker", "(I)I",
            (void*) nativeGetChargeCyclefromBlocker },            
