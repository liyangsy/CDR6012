...
public final class SystemServer {
        ...
        mActivityManagerService.systemReady(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    reportWtf("starting Logcat Service", e);
                }
            }
        });
    }
    ...
    static final void startLogcatService(Context context) {
        Intent intent = new Intent();
        intent.setComponent(new ComponentName("com.askey.exlogservice",
                    "com.askey.exlogservice.exLogService"));
        //Slog.d(TAG, "Starting service: " + intent);
        context.startServiceAsUser(intent, UserHandle.OWNER);
    }
}
