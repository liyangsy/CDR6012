...
public class WifiCommand extends Svc.Command {
    ...
    public void run(String[] args) {
        ...
        if (args.length >= 2) {
            ...
            // Add by Skysoft start
            else if ("apenable".equals(args[1])) {
                flag = true;
                validApCommand = true;
            } else if ("apdisable".equals(args[1])) {
                flag = false;
                validApCommand = true;
            }
            // Add by Skysoft end
            ...
            // Add by Skysoft start
                ...
                try {
                    ...
                    System.err.println("Wi-Fi Ap operation failed: " + e);
                }
                return;
            }
            // Add by Skysoft end
