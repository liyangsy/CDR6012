...
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
    static const char KEY_QC_SUPPORTED_VIDEO_WDR_MODES[];
    static const char KEY_QC_VIDEO_WDR[];	
...
/* Begin : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
    int32_t setVideoWDR(const QCameraParameters& );	
/* End : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */
...
/* Begin : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */
/* The Second Way use KEY_QC_VIDEO_WDR[] to enable/disable function */
    int32_t setVideoWDR(const char *videoWDR);
/* End : PU1-MOBILE-ASK-SW [PUM-136] WDR ON/OFF API support by John.Lin */	
