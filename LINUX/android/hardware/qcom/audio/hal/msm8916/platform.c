...
static const char * const device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_SPEAKER_VOIP] = "speaker",
    ...
    [SND_DEVICE_IN_HANDSET_MIC_SECOND] = "handset-mic-second",
    ...
    [SND_DEVICE_IN_CAMCORDER_MIC_NS] = "camcorder-mic-ns",
...
static int acdb_device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_SPEAKER_VOIP] = 238,
    ...
    [SND_DEVICE_IN_HANDSET_MIC_SECOND] = 4,
    ...
    [SND_DEVICE_IN_CAMCORDER_MIC] = 64,
    [SND_DEVICE_IN_CAMCORDER_MIC_NS] = 4,
...
static struct name_to_index snd_device_name_index[SND_DEVICE_MAX] = {
    ...
    {TO_NAME_INDEX(SND_DEVICE_IN_HANDSET_MIC_SECOND)},
    ...
    {TO_NAME_INDEX(SND_DEVICE_IN_CAMCORDER_MIC_NS)},
            ...
            if (adev->bt_wb_speech_enabled)
                ...
                if (my_data->is_vbat_speaker)
                    ...
                    if (mode == AUDIO_MODE_IN_COMMUNICATION)
                        snd_device = SND_DEVICE_OUT_SPEAKER_VOIP;
                    else
    ...
    if ((out_device != AUDIO_DEVICE_NONE) && ((mode == AUDIO_MODE_IN_CALL) ||
        ...
        if (in_device & AUDIO_DEVICE_IN_BUILTIN_MIC ||
            ...
            if (my_data->fluence_type & FLUENCE_DUAL_MIC &&
                ...
                property_get("persist.sys.noisesuppression", value, "0");
                if(!strcmp(value, "1")) {
                    snd_device = SND_DEVICE_IN_CAMCORDER_MIC_NS;
                }
                else {
